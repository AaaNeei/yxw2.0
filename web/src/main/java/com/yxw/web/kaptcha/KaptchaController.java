...
public class KaptchaController {
    ...
    public String loginCheck(HttpServletRequest request,
        ...
        String kaptchaExpected = (String) redisTemplate.opsForValue().get(Constants.KAPTCHA_SESSION_KEY + request.getSession().getId());
        //删除 redis缓存的 验证码
        redisTemplate.delete(Constants.KAPTCHA_SESSION_KEY + request.getSession().getId());
